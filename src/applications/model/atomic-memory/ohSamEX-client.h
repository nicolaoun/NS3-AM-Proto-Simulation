...
#ifndef AM_OHSAMEX_CLIENT_H
#define AM_OHSAMEX_CLIENT_H
...
/**
 * \ingroup ohSamEX
 * \brief A ohSamEX client
 *
 * Every packet sent should be returned by the server and received here.
 */
class ohSamEXClient : public Application
{
public:
	/**
