...
main (int argc, char *argv[])
{
    ...
    //
    NS_LOG_INFO ("Run Simulation: ABD MWMR star p2p.");
    //std::cout<<"Run Simulation: oh-Sam SPIKE."<<std::endl;
    Simulator::Run ();
    Simulator::Destroy ();
    NS_LOG_INFO (">>>> ABD MWMR star p2p Scenario - Servers:"<<numServers<<", Readers:"<<numReaders<<", Writers:"<<numWriters<<", Failures:"<<numFail<<", ReadInterval:"<<readInterval<<", WriteInterval:"<<writeInterval<<", <<<<");
