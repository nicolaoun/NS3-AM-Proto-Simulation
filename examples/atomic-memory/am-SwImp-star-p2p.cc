...
main (int argc, char *argv[])
{
	...
	//
	NS_LOG_INFO ("Run Simulation: SW Impossibility star p2p SWMR");
	//std::cout<<"Run Simulation: SwImp SPIKE."<<std::endl;
	Simulator::Run ();
	Simulator::Destroy ();
	NS_LOG_INFO (">>>> SW Impossibility  Scenario - Servers:"<<numServers<<", Readers:"<<numReaders<<", Writers:1, Failures:"<<numFail<<", ReadInterval:"<<readInterval<<", WriteInterval:"<<writeInterval<<", <<<<");
